...
// Invalidador de tamaño para corregir problemas de renderizado de Leaflet cuando el mapa se muestra en pestañas dinámicas.
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <button
                      ...
                      className={`py-3.5 rounded-2xl text-sm font-semibold transition cursor-pointer border flex items-center justify-center gap-2 ${transportMode === "driving"
                    ...
                    <button
                      ...
                      className={`py-3.5 rounded-2xl text-sm font-semibold transition cursor-pointer border flex items-center justify-center gap-2 ${transportMode === "walking"
                          ? "bg-brand-blue/10 dark:bg-brand-light/10 border-brand-blue/40 dark:border-brand-light/40 text-brand-blue dark:text-brand-light"
                          : "bg-slate-50 dark:bg-slate-800/40 border-slate-200 dark:border-white/5 text-slate-600 dark:text-slate-400"
                        }`}
                    >
                    ...
                    {categories.map((cat) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center gap-2.5 px-4 py-3 rounded-xl border text-xs font-semibold text-left transition cursor-pointer ${isChecked
                        ...
                        >
                          <span className={`w-4 h-4 rounded-md flex items-center justify-center border transition ${isChecked
              ...
              {activeItinerary.length === 0 ? (
                <div className="glass-panel rounded-3xl p-16 text-center max-w-lg mx-auto shadow-md border border-slate-200/50 dark:border-white/5 space-y-4">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">
                    Aún no tienes ningún itinerario en curso. Ve a la pestaña de <strong className="font-bold text-slate-700 dark:text-slate-350">Rutas Sugeridas</strong> o abre el <strong className="font-bold text-slate-700 dark:text-slate-350">Planificador</strong> para crear una ahora mismo.
                  </p>
                  <button
                          ...
                          return (
                            <div key={op.id} className="flex gap-4 relative group">
                              ...
                              <button
                                ...
                                className={`w-10 h-10 rounded-full flex items-center justify-center font-display font-extrabold text-sm border-2 shadow-md transition z-10 cursor-pointer ${isVisited
