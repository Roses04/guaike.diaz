...
const Navbar = () => {
  ...
  return (
    <>
      {/* MOBILE TOP HEADER */}
      <header className="md:hidden fixed top-0 left-0 right-0 z-50 bg-[#FAF9F5]/85 dark:bg-brand-dark/85 backdrop-blur-xl border-b border-stone-200/50 dark:border-white/5 py-3.5 px-6 flex justify-between items-center transition-colors duration-150">
        <Link to="/" className="text-xl font-display font-extrabold tracking-tight flex items-center gap-1">
          <span className="text-brand-blue dark:text-brand-light">GUAIKE</span>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to={profileRoute} className="w-10 h-10 rounded-[16px] bg-gradient-to-br from-brand-gold to-amber-500 flex items-center justify-center text-white shadow-lg shadow-brand-gold/20 border-2 border-[#FAF9F5] dark:border-brand-dark -rotate-3 hover:rotate-0 transition-transform">
