...
export const NetworkBanner: React.FC = () => {
  ...
  return (
    <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-[90%] max-w-md animate-in fade-in slide-in-from-top duration-300">
      {statusType === "offline" ? (
        <div className="bg-amber-950/70 border border-amber-500/30 backdrop-blur-xl rounded-2xl p-4 flex items-center gap-3 shadow-[0_8px_32px_0_rgba(245,158,11,0.15)] text-amber-200">
        ...
        <div className="bg-emerald-950/70 border border-emerald-500/30 backdrop-blur-xl rounded-2xl p-4 flex items-center gap-3 shadow-[0_8px_32px_0_rgba(16,185,129,0.15)] text-emerald-200 animate-out fade-out slide-out-to-top duration-500 delay-2500">
