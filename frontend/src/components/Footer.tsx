const Footer = () => {
  return (
    <footer className="hidden md:block bg-white/60 dark:bg-brand-dark/60 backdrop-blur-md border-t border-gray-200/50 dark:border-white/5 py-8 mt-auto text-slate-500 dark:text-slate-400 transition-colors duration-300">
